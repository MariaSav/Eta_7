...
<table id="listaus">
	<thead>	
		<tr>
			...
			<th><a id="uusiAsiakas" href="lisaysnatiivi.jsp">Lisää uusi asiakas</a></th>
		</tr>	
		<tr>
...
function haeTiedot(){	
	...
	.then(function (responseJson) {	
		...
		for(var i=0;i<asiakkaat.length;i++){			
        	htmlStr+="<tr id='rivi_"+asiakkaat[i].asiakas_id+"'>"; //tälle riville vaan <tr>"; jos ei ala toimia
        	htmlStr+="<td>"+asiakkaat[i].etunimi+"</td>";
        	htmlStr+="<td>"+asiakkaat[i].sukunimi+"</td>";
        	htmlStr+="<td>"+asiakkaat[i].puhelin+"</td>";
        	htmlStr+="<td>"+asiakkaat[i].sposti+"</td>";  
        	htmlStr+="<td><a href='muutosnatiivi.jsp?asiakas_id="+asiakkaat[i].asiakas_id+"'>Muuta</a>&nbsp;";
